                ...
                <div class="col-my-lg-8 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 ">
                                    <form class="form" id="submit-form" action="{{ route('admin.user.update') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-15">
                                                ...
                                                <div class="form-group row form-name">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input id="name" type="text" name="name" value="{{ old('name',$user->name) }}" class="form-control form-control-lg" placeholder="Name"/>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input id="email" type="text" name="email" value="{{ old('email',$user->email) }}" class="form-control form-control-lg" placeholder="E-mail"/>
                                                ...
                                                <div class="form-group row form-phone">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input id="phone" type="tel" name="phone" value="{{ old('phone',$user->phone) }}" class="form-control form-control-lg" placeholder="Phone"/>
                                                    ...
                                                    <div class="col-lg-2">
                                                        <select class="form-control" name="roles" id="roles">
                                                            @foreach($roles as $role)
                                                                <option {{ $user->roles[0]->id == $role->id ? 'selected':null }} value="{{ $role->id }}">{{ $role->name }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="form-group row form-owner" style="display:none">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input id="owner" type="tel" name="owner" value="{{ old('owner',$user->owner) }}" class="form-control form-control-lg"
                                                ...
                                                <div class="form-group row form-established" style="display:none">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input id="established" type="date" name="established" value="{{ old('established',$user->established) }}" class="form-control form-control-lg"
                                                ...
                                                <div class="form-group row form-gender" style="display:none">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <select class="form-control" name="gender" id="gender">
                                                            <option {{ old('gender',$user->gender) == 0 ? 'selected':null }} value="0">-= Select =-</option>
                                                            <option {{ old('gender',$user->gender) == 1 ? 'selected':null }} value="1">Male</option>
                                                            <option {{ old('gender',$user->gender) == 2 ? 'selected':null }} value="2">Female</option>
                                                        </select>
                                                ...
                                                <div class="form-group row form-hourly_rate" style="display:none">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input id="hourly_rate"  type="number" min="0" step="0.01" name="hourly_rate" value="{{ old('hourly_rate',$user->hourly_rate) }}" class="form-control form-control-lg"
                                                ...
                                                <div class="form-group row form-time_rate" style="display:none">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input id="time_rate" type="text" name="time_rate" value="{{ old('time_rate',$user->time_rate) }}" class="form-control form-control-lg" placeholder="Time Rate"/>
                                                        <p class="light-pink-text mb-0">Provide your hourly rate without currency symbol</p>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <select class="form-control" name="country" id="country">
                                                            ...
                                                            @foreach($countries as $country)
                                                                <option {{ old('country',$user->country) == $country->id ? 'selected':null }} value="{{ $country->id }}">{{ $country->name }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="form-group row form-address" style="display:none">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input id="address" type="text" name="address" value="{{ old('address',$user->address) }}" class="form-control form-control-lg"
                                                               placeholder="Address"/>
                                                ...
                                                <div class="form-group row form-longitude" style="display:none">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <input id="longitude" type="text" name="longitude" value="{{ old('longitude',$user->longitude) }}" class="form-control form-control-lg"
                                                ...
                                                <div class="form-group row form-latitude" style="display:none">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <input id="latitude" type="text" name="latitude" value="{{ old('latitude',$user->latitude) }}" class="form-control form-control-lg"
                                                ...
                                                <div class="form-group row form-postalcode" style="display:none">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <input id="postalcode" type="text" name="postalcode" value="{{ old('postalcode',$user->postalcode) }}" class="form-control form-control-lg"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select form="submit-form" class="form-control" name="status" id="status">
                                        <option {{ $user->status == 0 ? 'selected':null }} value="0">Passive</option>
                                        <option {{ $user->status == 1 ? 'selected':null }} value="1">Active</option>
                                        <option {{ $user->status == 2 ? 'selected':null }} value="2">Deleted</option>
                                    </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select form="submit-form" class="form-control" name="approve">
                                            <option {{ old('approve',$user->approve) == 0 ? 'selected' : '' }} value="0">No</option>
                                            <option {{ old('approve',$user->approve) == 1 ? 'selected' : '' }} value="1">Yes</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 ">
                                    ...
                                    <div class="crop-photo-container">
                                        ...
                                        <div class="cabinet center-block">
                                            @if(old('profile_photo_upload', !empty($user->profile_photo)))
                                            ...
                                            <figure>
                                                <img
                                                    src="{{ old('profile_photo_upload',!empty($user->profile_photo) ? asset('storage/profile/'. $user->profile_photo) : asset('storage/no-image.png')) }}"
                                ...
                                <div class="col-md-12 ">
                                    ...
                                    <div class="crop-photo-container" style="height: 100px;">
                                        ...
                                        <div class="cabinet center-block" style="height: 100px;">
                                            @if(old('banner_image', !empty($user->banner_image)))
                                                <div tooltip="Delete Banner" id="notPhotoBanner">
                                                    <i class="ki ki-bold-close icon-xs text-muted"></i>
                                                </div>
                                            @endif
                                            <figure>
                                                <img src="{{ old('banner_image',!empty($user->banner_image) ? asset('storage/profile/'. $user->banner_image) : asset('storage/company-bg.jpg')) }}" class="gambar img-responsive img-thumbnail" id="crop-item-img-outputBanner" style="height: 100px"/>
                                            </figure>
