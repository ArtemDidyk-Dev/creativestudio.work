...
{{--                            @endif--}}
                        ...
                        @foreach($reviews as $review)
                            <tr class="table-id-{{ $review->id }}" data-index="{{ $review->id }}" data-position="{{ $review->sort }}">
...
{{--                                </td>--}}
                                ...
                                <!-- project_name -->
                                <td class="sortableHandle">{{ $review->project_name }} ({{ $review->project_id }})</td>
                                        ...
                                        <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right"
                                            ...
                                            <ul class="navi navi-hover">
                                                ...
                                                <li
                                                    ...
                                                    <a href="{{ route('admin.review.edit',$review->id) }}" class="navi-link text-center">
                ...
                <div class="card-footer">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="d-flex flex-wrap py-2 mr-3">
                            {{ $reviews->appends(['search' => isset($searchText) ? $searchText : null])
                            ...
                            if (result.value) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (response) {
                                        ...
                                        if (response.success) {
                                            $('.table-id-'+reviewID).fadeOut(1000);
